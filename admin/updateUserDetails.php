...
<?php
  ...
  // Checking if all the data is not empty//
        ...
        {
    $query = "UPDATE user_tbl SET  firstname = '$fname', middlename = '$mname', lastname = '$lname', email = '$email' WHERE u_id = '$id'";
    
    if($result = mysqli_query($con, $query)) 
    {
      $_SESSION['success_message'] = "User Details is succesfully updated!";
