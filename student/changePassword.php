<?php 
  ...
  if(isset($_POST['update'])) {
    ...
    $query = "SELECT password FROM student_tbl WHERE password = '$oldpass'";
    ...
    if(mysqli_num_rows($result) > 0) {
      ...
      if($newpass == $confirmpass) {
        ...
        $query = "UPDATE student_tbl SET password = '$newpass' WHERE student_number ='".$_SESSION['student_number']."'";
